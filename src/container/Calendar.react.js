...
type Props = {
  ...
  dayViewDisabled?: ViewPropTypes.style,
      ...
      >
        ...
        >
          <View style={[styles.barView, this.props.barView]}>
            ...
            >
              <Text style={this.props.barText}>{this._stageText()}</Text>
            </TouchableHighlight>
        ...
        <View style={[styles.stageWrapper, this.props.stageView]}>
          {this.state.stage === DAY_SELECTOR ? (
            <DaySelector
              ...
              dayViewDisabled={this.props.dayViewDisabled}
            ...
            <MonthSelector
              ...
              monthViewDisabled={this.props.monthViewDisabled}
